  ...
  return (
    <div className="space-y-4">
      <Card className="overflow-hidden">
        ...
        <div className="detail-hero-grid p-6">
          <div className="min-w-0">
            <p className="text-sm uppercase tracking-[0.24em] text-[var(--brand)]">Property detail</p>
            <h1 className="page-title mt-3 font-[var(--font-display)]">{property.name}</h1>
          ...
          <div className="card-grid-compact mt-5">
            {property.units.map((unit) => (
              <Link key={unit.id} href={`/units/${unit.id}`}>
                <div className="rounded-2xl border border-[var(--line)] bg-white/70 p-5 transition hover:bg-white">
                  <div className="flex items-center justify-between">
